...
const Cadastro = () => {
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem("dataDeNascimento", nascimento);
    localStorage.setItem("estado", estado);
    localStorage.setItem("cidade", city);
    localStorage.setItem("campanhaFoto", campanha);
    localStorage.setItem("perfilFoto", perfil);
    localStorage.setItem("dataDeEncerramento", encerramento);
    localStorage.setItem("faleSobre", cotrip);
    localStorage.setItem("opcoesDeDestino", destino);
    localStorage.setItem("outrasDatas", data);
    localStorage.setItem("hospedagem", hospedagem);
      ...
      >
        <fieldset>
          ...
          <select
            ...
            className="input-field"
            value={estado}
            onChange={({ target }) => [setEstado(target.value), setError("")]}
          >
            <option value="--">--</option>
        ...
        <fieldset>
          ...
          <select
            ...
            className="input-field"
            value={hospedagem}
            onChange={(e) => [setHospedagem(e.target.value), setError("")]}
          >
            <option value="--">--</option>
